...
# 2. Listar registros
curl -H "Authorization: Bearer $TOKEN" http://localhost:8080/api/beneficiarios
...
|----------|---------|---------|
| `/api/beneficiarios` | GET / POST / PUT / DELETE | CRUD de Beneficiario |
| `/api/prestadors` | GET / POST / PUT / DELETE | CRUD de Prestador |
| `/api/autorizacaos` | GET / POST / PUT / DELETE | CRUD de Autorizacao |
| `/api/utilizacaos` | GET / POST / PUT / DELETE | CRUD de Utilizacao |
